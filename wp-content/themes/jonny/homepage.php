...
?>
    ...
    <div id="fullpage">
        ...
        <div class="section first-page active" data-section-name="home">
            <video autoplay muted loop preload id="video-bg" src="<?php do_action('homepage-get_media', 'first_page_background', '') ?>"></video>
        ...
        function toggleHome(on) {
            if (on) {
                ...
                setTimeout(function () {
                    ...
                    $("#scroll-down-container").removeClass('hide').fadeIn(900);
                }, 1000);
                $.scrollify.enable();
                ...
                // console.log($("#first-page-logo").removeClass("active"));
            }
        }
