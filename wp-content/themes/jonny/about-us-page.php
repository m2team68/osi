...
<?php
get_header();
$aboutUsBg = get_theme_file_uri('assets/images/OUR_COMPANY_BG.jpg');
                ...
                <div class="right">
                    <div class="right-content">
                        ...
                        <div class="right-desc">
                            ...
                            strength to compete with big companies on the market, we currently emphasize on developing
